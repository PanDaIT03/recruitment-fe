const PATH = {
  ...
  EMPLOYER_CANDIDATES_DASHBOARD: '/employer/manage-candidates',
  EMPLOYER_CANDIDATES_MANAGEMENT: '/employer/management-candidates',
  EMPLOYER_CANDIDATES_ADD_NEW: '/employer/add-new-candidate',
